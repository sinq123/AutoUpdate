...
BEGIN_MESSAGE_MAP(CAutoUpdateDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_CHECKUPDATE, &CAutoUpdateDlg::OnBnClickedCheckupdate)
END_MESSAGE_MAP()
...
//检查更新
void CAutoUpdateDlg::OnBnClickedCheckupdate()
{
	// TODO: 在此添加控件通知处理程序代码
	AfxBeginThread(VersionUpdate::ThreadCheckVer,this);//自动更新线程
}
